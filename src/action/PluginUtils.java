...
public class PluginUtils {
	...
	public enum FileType {Java,Gradle,Xml};
	...
	public void createFile(FileType fileType,String templateName,String createFolderName){
		String createFileName = "";
		if(templateName.contains("/")){
			String code[] = templateName.split("/");
			createFileName = code[code.length - 1].split("\\.")[0] + GetFileSuffix(fileType);
		}else{
			createFileName = templateName.split("\\.")[0] + GetFileSuffix(fileType);
		}
	...
	public void createFile(String templateName,String createFolderName,String createFileName){
		...
		}else if(createFolderName.contains("res")){
			apiPath = mProject.getBasePath() + "/app/src/main/" + createFolderName;
		}else{
	 ...
	 */
	@NotNull
	private String GetFileSuffix(FileType fileType) {
		String fileSuffix = "";
		switch (fileType){
			case Java:
				fileSuffix = ".java";
	...
	private String getAppPath(){
		...
		return  mProject.getBasePath() + "/app/src/main/java/" + packagePath + "/";
